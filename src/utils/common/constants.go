...
const (
	...
	PrimitiveObjectIDError = "An error occurred while obtaining the primitive object ID from registered user"
	PasswordEncryptError   = "An error occurred while trying to encrypt the user password: "
)
